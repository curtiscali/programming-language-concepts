...
(let* ((example "let x = z in (3*(20 / 5)+69)-1")
       (i (open-input-string example)))
    (= (meaning (parse-lang (lambda () (get-token i))) empty-env init-k) 80))

(let* ((example "let x = z in -((3*(20 / 5)+69)-1)")
       (i (open-input-string example)))
    (= (meaning (parse-lang (lambda () (get-token i))) empty-env init-k) -80))

(let* ((example "let x = z, y = 1/0 in (3*(20 / 5)+69)-1")
       (i (open-input-string example)))
    (= (meaning (parse-lang (lambda () (get-token i))) empty-env init-k) 80))

(let* ((example "let x = 1, y = 1/0 in ((3*(20 / 5)+69)-1)+x")
       (i (open-input-string example)))
    (= (meaning (parse-lang (lambda () (get-token i))) empty-env init-k) 81))
...
(let* ((example "(\\x,y\\->x)((3*(20 / 5)+69)-1,z)")
       (i (open-input-string example)))
    (= (meaning (parse-lang (lambda () (get-token i))) empty-env init-k) 80))
...
(let* ((example "(\\x,y\\->(x*x)+y)(5,5)")
       (i (open-input-string example)))
    (= (meaning (parse-lang (lambda () (get-token i))) empty-env init-k) 30))

(let* ((example "let f = (\\x,y\\->(x*x)), y = 1/0 in f(5,y)")
       (i (open-input-string example)))
    (= (meaning (parse-lang (lambda () (get-token i))) empty-env init-k) 25))